...
public class Instructor {
    @FXML
    Text questionHeading, answerText;
    @FXML
    TextField enterQuestion, maximumScoreInput, expectedAnswerInput, optionA, optionB, optionC, optionD, quizTitle, quizDescription;
    @FXML
    RadioButton type;
    @FXML
    VBox maximumScore, expectedAnswer, options, optionInput;
    @FXML
    Button finish;
    @FXML
    ...
    public void onClickCreate(ActionEvent event) throws IOException {
        /** if nothing entered show error message else create quiz */
    ...
    public void onAddQuestion() {
        questionCount++;
        questionType = (RadioButton) type.getToggleGroup().getSelectedToggle();

        // show relavent fields according to the question type
        if (questionType == null) {
            sample.alertBox.display("Alert", "Kindly select one answer type for your question.");
        } else if (Objects.equals(questionType.getText(), "MCQs")) {
            questionHeading.setVisible(true);
            questionHeading.setText("Q" + questionCount);
        ...
        } else if (Objects.equals(questionType.getText(), "True/False") || Objects.equals(questionType.getText(), "Numeric")) {
            questionHeading.setVisible(true);
            questionHeading.setText("Q" + questionCount);
            enterQuestion.setVisible(true);
            answerText.setVisible(true);
    ...
    public void onQuestionFinish() throws IOException {
        if (Objects.equals(questionType.getText(), "True/False") || Objects.equals(questionType.getText(), "Numeric")) {
            if (Objects.equals(enterQuestion.getText(), "") || Objects.equals(maximumScoreInput.getText(), "") || Objects.equals(expectedAnswerInput.getText(), "")) {
                ...
                UserData.writeQuizFileOther(questionType, questionCount, enterQuestion, maximumScoreInput, expectedAnswerInput);
                ...
                questionList.getItems().add("Q" + questionCount);
            }
        } else if (Objects.equals(questionType.getText(), "MCQs")) {
            ...
            if (Objects.equals(enterQuestion.getText(), "") || Objects.equals(optionA.getText(), "") || Objects.equals(optionB.getText(), "") || Objects.equals(optionC.getText(), "") || Objects.equals(optionD.getText(), "") || Objects.equals(maximumScoreInput.getText(), "") || Objects.equals(expectedAnswerInput.getText(), "")) {
                ...
                UserData.writeQuizFileMCQs(questionType, questionCount, enterQuestion, optionA, optionB, optionC, optionD, maximumScoreInput, expectedAnswerInput);
                questionHeading.setVisible(false);
                enterQuestion.setVisible(false);
                enterQuestion.setText("");
                maximumScore.setVisible(false);
